class WeightHistoriesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @weight_history.update(weight_history_params)
        format.html { redirect_to @weight_history, notice: "Weight history was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to weight_histories_path, notice: "Weight history was successfully destroyed.", status: :see_other }
